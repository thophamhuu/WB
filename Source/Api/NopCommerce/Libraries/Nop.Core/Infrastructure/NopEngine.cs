...
namespace Nop.Core.Infrastructure
{
    ...
    public class NopEngine : IEngine
    {
        ...
        protected virtual void RegisterDependencies(HttpConfiguration httpConfig, NopConfig config)
        {
            RegisterDependencies(config);
            //set dependency resolver
            httpConfig.DependencyResolver = new AutofacWebApiDependencyResolver(this._containerManager.Container);
        }
        ...
        /// <param name="httpConfig"></param>
        /// <param name="config"></param>
        public void Initialize(HttpConfiguration httpConfig, NopConfig config)
        {
            //register dependencies
            RegisterDependencies(httpConfig, config);
